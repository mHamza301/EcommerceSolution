      ...
      <form onSubmit={submitHandler} >
        <ul className="form-container">
          ...
          <li>
            ...
            <input type="name" name="Pname" id="Pname" required onChange={(e) => setPname(e.target.value)}>
            </input>
          </li>
          <li>
            <label htmlFor="image">
            ...
            <input type="file" name="image" id="image" required onChange={(e) => setImage(e.target.value)}>
            </input>
          </li><li>
            <label htmlFor="name">
              Selling Price
            </label>
            <input type="name" name="SP_per_unit" id="SP_per_unit" required onChange={(e) => setSP_per_unit(e.target.value)}>
            </input>
          </li>
          <li>
            <label htmlFor="name">
            ...
            <input type="name" name="avail_quantity" id="avail_quantity" required onChange={(e) => setAvail_quantity(e.target.value)}>
            </input>
          </li>
          <li>
            <label htmlFor="name">
            ...
            <input type="name" name="category" id="category" required onChange={(e) => setCategory(e.target.value)}>
            </input>
          </li>
          <li>
